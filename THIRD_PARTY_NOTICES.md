...
본 프로젝트를 활용하실 때는 위 의존성들의 원본 라이선스를 함께 확인해주시기 바랍니다. 본 문서는 작성 시점을 기준으로 정리한 참고 자료이며, 각 의존성의 정확한 라이선스 조건과 적용 범위는 원본 배포처에서 제공하는 라이선스 문서를 기준으로 합니다. 또한 라이선스 정보는 시간이 지나며 변경될 수 있으므로, 활용 목적에 따라 필요한 경우 각 의존성의 공식 페이지를 참고해주시기 바랍니다.
